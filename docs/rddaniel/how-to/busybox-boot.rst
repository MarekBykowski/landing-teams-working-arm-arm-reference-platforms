How to build RD-Daniel platform software to validate busybox boot
=================================================================
...
Busybox boot on RD-Daniel platform
----------------------------------

Busybox is a lightweight executable which packages lots of POSIX compliant UNIX
utilities in a single file system. The busybox boot test on RD-Daniel platform
ensures that the RD-Daniel software stack which runs on the model is able to
...
platforms which are derivative of the RD-Daniel platform as this test can be
...
Procedure to build Busybox boot test for RD-Daniel platform
-----------------------------------------------------------
...
To build the software stack, the command to be used is
   ...
   ::
        ...
        ./build-scripts/rdinfra/build-test-busybox.sh -p rddaniel <command>
...
Examples of the build command are
   ...
   -   ::
        ...
        ./build-scripts/rdinfra/build-test-busybox.sh -p rddaniel build

      - This command performs an incremental build of the software components
        included in the software stack for the RD-Daniel platform. Note: this
...
Procedure for validating Busybox boot test for RD-Daniel platform
-----------------------------------------------------------------

After the build for busybox boot test is complete, the following command starts
the execution of the *RD-Daniel* fastmodel and the software boots up to the
...
To boot up to the busybox prompt, the command to be used is
   ...
   ::
        ...
        ./boot.sh -p rddaniel -a <additional_params> -n [true|false]
