How to build RD-N1-Edge platform software to validate busybox boot
==================================================================
...
Busybox boot on RD-N1-Edge platform
-----------------------------------

Busybox is a lightweight executable which packages lots of POSIX compliant UNIX
utilities in a single file system. The busybox boot test on RD-N1-Edge platform
ensures that the RD-N1-Edge software stack which runs on the model is able to
...
platforms which are derivative of the RD-N1-Edge platform as this test can be
...
*RD-N1-Edge* fastmodel.

Procedure to build Busybox boot test for RD-N1-Edge platform
------------------------------------------------------------
...
To build the software stack, the command to be used is
   ...
   ::
        ...
        ./build-scripts/rdinfra/build-test-busybox.sh -p rdn1edge <command>
...
Examples of the build command are
   ...
   -   ::
        ...
        ./build-scripts/rdinfra/build-test-busybox.sh -p rdn1edge build
...
Procedure for validating Busybox boot test for RD-N1-Edge platform
------------------------------------------------------------------

After the build for busybox boot test is complete, the following command starts
the execution of the *RD-N1-Edge* fastmodel and the software boots up to the
...
To boot up to the busybox prompt, the command to be used is
   ...
   ::
        ...
        ./boot.sh -p rdn1edge -a <additional_params> -n [true|false]
